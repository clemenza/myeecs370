...
int parse(char *, int *);/* element function of whole program, parse instruction line by line, and translate it into machine code, take char * as input, output machine code to char ** */

static void Rtypei(char *, int, int *);
static void Itypei(char *, int, int *);
